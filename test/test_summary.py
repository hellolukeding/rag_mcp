...
print("\n2. 运行测试:")
print("   poetry run python -m test.test_mcp_components  # 组件测试")
print("   poetry run python -m test.test_mcp_simple      # 简单通信测试")
print("   poetry run python -m test.test_mcp_detailed    # 详细功能测试")
